...
package com.dao.modal;

import java.io.Serializable;
import java.util.Date;
/**
 * This class represents the User model. This model class can be used thorough out all
...
public class User implements Serializable {
	...
	public String toString() {
		return String
				.format("User[id=%d,email=%s,firstname=%s,lastname=%s,birthdate=%s]", id, email, firstname, lastname, birthdate);
	}
